...
public class GonzahipsteroneApp {

    private static final Logger log = LoggerFactory.getLogger(GonzahipsteroneApp.class);

    private final Environment env;

    public GonzahipsteroneApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes gonzahipsterone.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(GonzahipsteroneApp.class);
